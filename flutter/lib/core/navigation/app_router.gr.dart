...
class RegisterRoute extends PageRouteInfo<void> {
  ...
  static PageInfo page = PageInfo(
    name,
    builder: (data) => const RegisterPage(),
  );
}
...
class RoleSelectionRoute extends PageRouteInfo<void> {
  ...
  static PageInfo page = PageInfo(
    name,
    builder: (data) => const RoleSelectionPage(),
  );
}
